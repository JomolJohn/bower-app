...
export const NOTIFICATION_TEXT = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard";
...
export const MENU_LINKS = [
    { name: "Home", path: "/" },
    { name: "Creating Packages", path: "/packages" },
    { name: "API", path: "/api" },
    { name: "Configuration", path: "/configuration" },
    { name: "Pluggable Resolvers", path: "/resolvers" },
...
export const FOOTER_TEXT = [
    "© 2024 Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
    "The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from `de Finibus Bonorum et Malorum` by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.",    
];
